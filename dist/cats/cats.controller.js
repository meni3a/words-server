...
let CatsController = class CatsController {
    ...
    async create(createDogDto) {
        const cat = (0, class_transformer_1.plainToInstance)(cat_entity_1.Cat, createDogDto);
        await cat.validate(OpertaionType_1.Opertaion.Create);
...
__decorate([
    ...
    __metadata("design:paramtypes", [cat_entity_1.Cat]),
